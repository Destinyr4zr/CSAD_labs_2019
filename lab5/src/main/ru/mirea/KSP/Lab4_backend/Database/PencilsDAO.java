...
public class PencilsDAO {
    ...
    public  void insertPencil(int id, String date, String color, String length) throws HibernateException
    {session.saveOrUpdate(new PencilsModel(id, date,color,length));}
