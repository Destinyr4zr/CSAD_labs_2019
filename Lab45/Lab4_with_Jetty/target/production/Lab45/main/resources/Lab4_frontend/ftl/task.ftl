...
<body>
   <nav class="nav">
        <a class="nav_link" href="index.html"><strong><i>Главная</i></strong></a>
        <a class="nav_link" href="task.html"><i>Индивидуальное задание</i></a>
        <a class="nav_link" href="table.html"><i>Работа с таблицей</i></a>
    </nav>
    ...
    <div class="textPicture">
        <form>
            ...
            <b><p align="center" id="result" style="background-color:dimgrey; color: darkorange; width: 10%; height: 10%; margin: auto; margin-top: 40px;">${result}</p></b>
        </form>
    </div>
